<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      <inertia-link class="text-indigo-400 hover:text-indigo-600" :href="route('tasks.get_student_upload', task.id)">List Upload Tugas</inertia-link>
      <span class="text-indigo-400 font-medium">/</span> Import {{ name }}
    </h1>
    <!-- <div class="mb-6 flex justify-between items-center">

       <a :href="route('export-task-mark', task.id)" class="btn-indigo" target="_blank">Template Nilai</a>
    </div> -->
          ...
          <div class="mb-4">
            ...
            <b-collapse id="collapse-1" class="mt-2">
              ...
              <p class="text-gray-600">
                &#9679; Template id_task, task, user_id, nama, nilai<br>
                &#9679; Data nama murid yang ditampilkan adalah yang telah mengumpulkan tugas<br>
                &#9679; Anda hanya tinggal mengisi nilai saja, apa bila ada murid yang telah anda nilai,<br>
                &nbsp; maka akan tampil nilainya dan akan ikut berubah sesuai yang anda isi.
              </p>
              </div>
            </b-collapse>
          </div>
