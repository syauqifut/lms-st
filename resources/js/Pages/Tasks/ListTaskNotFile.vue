<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      ...
      <span class="text-indigo-400 font-medium">/</span> Student Upload List
    </h1>
    ...
    <div class="mb-6 flex justify-between items-center overflow-x-auto">
      <a v-if="taskFiles.data.length > 0" :href="route('tasks.download_zip', task.id)" class="btn-indigo" target="_blank">Download ZIP</a>
    ...
    <div class="bg-white rounded shadow overflow-x-auto">
     <table class="w-full no-wrap">
        <tr class="text-left font-bold">
          ...
          <th class="px-6 pt-6 pb-4">Download File</th>
          <th class="px-6 pt-6 pb-4">View File</th>
        ...
        >
          ...
          <td class="border-t">
            <a :href="route('tasks.download_uploaded_task', taskFile.id)" class="text-blue-500 text-lg hover:underline" target="_blank">{{ taskFile.file.substring(11,29)}}<span v-if="taskFile.file.length>=29">...</span></a>
          </td>
          <td class="border-t">
            <span v-if="taskFile.file">
              <a :href="route('lihattugas', taskFile.id)" class="text-blue-500 text-lg hover:underline" target="_blank">View File</a>
            </span>
          </td>
          <td class="border-t">
            <inertia-link
          ...
          <!-- <td class="border-t">
            <div>
              <span class="font-bold py-2">{{ taskFile.tgl_pengumpulan > task.due_date ? 'LATE' : '' }}</span>
            </div>
            {{ taskFile.tgl_pengumpulan }}
          </td> -->
          <td class="border-t">
            <div class="flex">
