<template>
  <div>
    <div class="bg-gray-100 font-bold rounded shadow-xl py-5 px-5 w-full mb-10">
      <h1 class="mb-8 font-bold text-3xl">Report by Parent</h1>
    ...
    <div class="bg-gray-100 font-bold rounded shadow-xl py-5 px-5 w-full mb-10" v-if="anak">
      <h1 class="mb-8 font-bold text-3xl">Children Report</h1>
      ...
      <div class="w-full flex flex-wrap">
        <div class="w-full sm:w-1/2 md:w-2/4 px-3 text-left">
          <div class="p-5 xl:px-8 md:py-5">
            ...
            <h6 class="text-xl mb-3">Group/Homegroup Teacher : {{info[0]['kelas']}}/{{info[0]['walikelas']}}</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div  v-if="anak">
      <div class="bg-gray-100 font-bold rounded shadow-xl py-5 px-5 w-full mb-10">
        <h1 class="mb-8 font-bold text-3xl">Children Report Data</h1>
...
export default {
  metaInfo: { title: 'Report by Parent' },
  layout: Layout,
  components: {
  ...
  methods: {
    cari() {
      ...
      this.$inertia.replace(this.route('report.ortu',
        {
          id_anak: id_anak,
          kelas: kelas,
        }
