<template>
  <div>
    <div class="bg-gray-100 font-bold rounded shadow-xl py-5 px-5 w-full mb-10" v-if="isMobile()">
      <h1 class="mb-8 font-bold text-3xl">Reports by Subject </h1>
      <div class="mb-6 flex items-center">
        <div class="w-full h-12 py-2 px-5" >
          <h1 class="mb-1">Subject :</h1>
          <v-select v-model="form.subject" label="namecode" :reduce="matkul => matkul.id" :options="matkul" />
        </div>
      </div>
      <div class="mb-6 flex items-center">
        <div class="w-full h-12 py-2 px-5">
    ...
    <div class="bg-gray-100 font-bold rounded shadow-xl py-5 px-5 w-full mb-10" v-if="!isMobile()">
      <h1 class="mb-8 font-bold text-3xl">Report by Subject </h1>
      <div class="mb-6 flex items-center">
    ...
    <div  v-if="subject && group">
      <div class="bg-gray-100 font-bold rounded shadow-xl py-5 px-5 w-full mb-10">
        <h1 class="mb-8 font-bold text-3xl">Report by Subject Data</h1>
        <div class="mb-6 flex justify-between items-center" v-if="report.length !== 0">
          <a class="btn-indigo" :href="route('report-subject', [info[0]['subject_id'], info[0]['group_id']])">
          <!-- <a class="btn-indigo" :href="route('report-subject', [form.subject, form.kelas])"> -->
...
export default {
  ...
  methods: {
    cari() {
      ...
      this.$inertia.replace(this.route('report.guru',
        {
          subject: subject,
          kelas: kelas,
        }
