<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">Group</h1>
    <!-- view mobile -->
    ...
    <div class="mb-6 flex justify-between items-center" v-if="isMobile()">
      <inertia-link v-if="$page.auth.user.usertype_id  == 1 || $page.auth.user.usertype_id  == 4" class="btn-indigo" :href="route('groups.create')">
        <span>Create</span>
      </inertia-link>
      ...
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="group in groups.data" :key="group.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          ...
          <td class="border-t w-px">
            <div>
              <div v-if="$page.auth.user.usertype_id == 1 || $page.auth.user.usertype_id == 4" class="inline-flex">
  ...
  watch: {
    form: {
      handler: throttle(function() {
        ...
        this.$inertia.replace(this.route('groups', Object.keys(query).length ? query : { remember: 'forget' }))
      }, 150),
      deep: true,
    },
  },
