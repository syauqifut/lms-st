    ...
    <div class="lg:flex justify-evenly">
      ...
      <div class="flex-1 lg:mt-2 mt-3">
        <div class="bg-white mx-auto p-6">
          <div class="mb-4">
            ...
            <b-collapse id="collapse-1" class="mt-2">
              ...
              <p class="text-gray-600">
                Untuk Inputan nama kelas, tahun, dan academicterms tidak boleh sama, tapi jika ada salah satu inputan berbeda dari ketiga kolom dan 2 kolom sisanya sama dengan data sebelumnya data masih bisa diinputkan
              </p>
              </div>
            </b-collapse>
          </div>
          <div class="mb-4">
            <b-button v-b-toggle.collapse-2 variant="primary" class="w-full">
              <div class="flex items-center justify-between bg-gray-200 pl-3 pr-2 py-3 w-full rounded text-gray-600 font-bold cursor-pointer hover:bg-gray-300">
                Inputan academic terms
                <span class="h-6 w-6 flex items-center justify-center text-teal-500">
                  <svg class="w-3 h-3 fill-current" viewBox="0 -192 469.33333 469" xmlns="http://www.w3.org/2000/svg"><path d="m437.332031.167969h-405.332031c-17.664062 0-32 14.335937-32 32v21.332031c0 17.664062 14.335938 32 32 32h405.332031c17.664063 0 32-14.335938 32-32v-21.332031c0-17.664063-14.335937-32-32-32zm0 0"/></svg>
                </span>
              </div>
            ...
            <b-collapse id="collapse-2" class="mt-2">
              <div class="p-3">
                <p class="text-gray-600">
                Untuk inputan academicterms untuk menentukan semester pembelajaran apakah ganjil atau genap <br>
                1 = Ganjil <br>
                2 = Genap <br>
              </p>
              </div>
          ...
          <div class="mb-4">
            <b-button v-b-toggle.collapse-3 variant="primary" class="w-full">
              <div class="flex items-center justify-between bg-gray-200 pl-3 pr-2 py-3 w-full rounded text-gray-600 font-bold cursor-pointer hover:bg-gray-300">
                Inputan Main Teacher
                <span class="h-6 w-6 flex items-center justify-center text-teal-500">
                  <svg class="w-3 h-3 fill-current" viewBox="0 -192 469.33333 469" xmlns="http://www.w3.org/2000/svg"><path d="m437.332031.167969h-405.332031c-17.664062 0-32 14.335937-32 32v21.332031c0 17.664062 14.335938 32 32 32h405.332031c17.664063 0 32-14.335938 32-32v-21.332031c0-17.664063-14.335937-32-32-32zm0 0"/></svg>
                </span>
              </div>
            ...
            <b-collapse id="collapse-3" class="mt-2">
              <div class="p-3">
                <p class="text-gray-600">
                Untuk inputan main teacher cukup menginputkan username guru, jika ada satu huruf yang berbeda maka inputan data akan ditolak
              </p>
              </div>
            </b-collapse>
          </div>
