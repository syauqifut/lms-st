<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">Import {{name}}</h1>
    <div class="mb-6 flex justify-between items-center">
      
      <a class="btn-indigo" :href="route( 'coursess.template')">
          ...
          <div class="mb-4">
            ...
            <b-collapse id="collapse-1" class="mt-2">
              ...
              <p class="text-gray-600">
                Input terdiri dari 8 kolom sebagai berikut: <br>
                title = Judul dari Courses <br>
                description = Deskripsi dari courses <br>
                Subject = subject dari courses, harus sesuai dengan data subject 'name' pada database <br>
                Category = kategori dari courses, harus sesuai dengan data kategori 'title' pada database <br>
                level = level dari courses, harus sesuai dengan data level 'title' pada database <br>
                group_id - Group = group dari courses, harus sesuai dengan data group 'id' dan 'classes' pada database <br>
                teacher = guru pengajar dari courses, harus sesuai dengan data 'username' pada database <br>
                <hr class="my-2">
...
export default {
  metaInfo: { title: 'Import Learning' },
  layout: Layout,
  components: {
    Icon,
    Pagination,
