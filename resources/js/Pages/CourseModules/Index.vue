          ...
          <div class="flex flex-wrap">
            ...
            <!-- Button Menu: Start -->
              <div class="pr-2" v-if="role.is_teacher">
                <div class="flex-wrap bg-purple-600 hover:bg-purple-800 rounded mb-3 xl:mb-0">
                  <div class="py-3 px-4">
                        <inertia-link class="py-1 text-sm text-white" :href="route('import-course-modules', dataCourse[0].id)">
                          <i class="fa fa-upload"></i> Import Learning Module
                        </inertia-link>
                  </div>
                </div>
              </div>
              <div class="pr-2" v-if="role.is_teacher">
                <div class="flex-wrap bg-green-600 hover:bg-green-800 rounded mb-3 xl:mb-0">
                  <div class="py-3 px-4">
                        <inertia-link class="py-1 text-sm text-white" :href="route('create.course.modules', dataCourse[0].id)">
            ...
            <div class="w-full mt-6 bg-gray-100 p-2 pb-6" v-for="modules in courseModules.data" :key="modules.id">
              ...
              <div  class="flex justify-between items-center mt-5" v-for="unit in modules.unit" :key="unit.id">
                <div v-if="unit.is_active === 1" class="text-gray-800 text-center inline-flex items-center">
                  ...
                  <a v-if="unit.is_active === 1" :href="route('course-unit.see', unit.id)" class="text-base font-semibold hover:underline text-gray-800 -ml-2">
                  {{unit.name}}
                </a>
                </div>
                <inertia-link v-if="unit.is_active === 1 && (role.is_teacher || role.is_admin)" class="fa fa-edit" :href="route('course-units.edit', unit.id)"></inertia-link>
              </div>
