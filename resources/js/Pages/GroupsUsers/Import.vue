<template>
  <div>
    ...
    <div class="mb-6 flex justify-between items-center">
      ...
      <a class="btn-indigo" :href="route('export-groups')">
          ...
          <div class="mb-4">
            ...
            <b-collapse id="collapse-1" class="mt-2">
              ...
              <p class="text-gray-600">
                Input hanya terdiri dari 2 kolom, group_id, dan username<br>
                group_id = Daftar list group id bisa dilihat pada daftar group yang ada <br>
                username = username pengguna yang masuk pada group user
              </p>
              </div>
            </b-collapse>
          </div>
