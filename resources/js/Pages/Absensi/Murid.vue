    ...
    <div class="bg-white rounded shadow overflow-x-auto">
      ...
      <table class="w-full whitespace-no-wrap">
        <tr class="text-left font-bold">
          <th class="px-6 pt-6 pb-4">Date of Module</th>
          <th class="px-6 pt-6 pb-4">Attendance Date</th>
          <th class="px-6 pt-6 pb-4">Learning</th>
          <th class="px-6 pt-6 pb-4">Hours of Module</th>
...
export default {
  ...
  methods: {
    cari() {
      ...
      this.$inertia.replace(this.route('absensi.absen_murid',
        {
          tgl_mulai: tgl_mulai,
          tgl_akhir: tgl_akhir,
          kelas: kelas,
